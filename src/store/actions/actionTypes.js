...
export const GET_USER_FEED_START = "GET_USER_FEED_START";
export const GET_USER_FEED_SUCCESS = "GET_USER_FEED_SUCCESS";
export const GET_USER_FEED_FAILED = "GET_USER_FEED_FAILED";
...
export const GET_NOTIFICATION_DATA_START = "GET_NOTIFICATION_DATA_START";
export const GET_NOTIFICATION_DATA_SUCCESS = "GET_NOTIFICATION_DATA_SUCCESS";
export const GET_NOTIFICATION_DATA_FAIL = "GET_NOTIFICATION_DATA_FAIL";

export const READ_NOTIFICATION = "READ_NOTIFICATION";
export const DELETE_NOTIFICATION = "DELETE_NOTIFICATION";

// Notification real-time listener
export const SUBSCRIBE_NOTIFICATIONS_START = "SUBSCRIBE_NOTIFICATIONS_START";
export const SUBSCRIBE_NOTIFICATIONS_SUCCESS =
  "SUBSCRIBE_NOTIFICATIONS_SUCCESS";
export const SUBSCRIBE_NOTIFICATIONS_FAIL = "SUBSCRIBE_NOTIFICATIONS_FAIL";

export const UNSUBSCRIBE_NOTIFICATIONS_START =
  "UNSUBSCRIBE_NOTIFICATIONS_START";
export const UNSUBSCRIBE_NOTIFICATIONS_SUCCESS =
  "UNSUBSCRIBE_NOTIFICATIONS_SUCCESS";
export const UNSUBSCRIBE_NOTIFICATIONS_FAIL = "UNSUBSCRIBE_NOTIFICATIONS_FAIL";

// Mark all as read
export const MARK_ALL_NOTIFICATIONS_READ_START = "MARK_ALL_NOTIFICATIONS_READ_START";
...
export const SAVE_FCM_TOKEN_START = "SAVE_FCM_TOKEN_START";
export const SAVE_FCM_TOKEN_SUCCESS = "SAVE_FCM_TOKEN_SUCCESS";
export const SAVE_FCM_TOKEN_FAIL = "SAVE_FCM_TOKEN_FAIL";

// Foreground toast notification
export const SHOW_NOTIFICATION_TOAST = "SHOW_NOTIFICATION_TOAST";
export const HIDE_NOTIFICATION_TOAST = "HIDE_NOTIFICATION_TOAST";
export const UPDATE_ORG_USER_PERMISSIONS_START = "UPDATE_ORG_USER_PERMISSIONS_START";
export const UPDATE_ORG_USER_PERMISSIONS_SUCCESS = "UPDATE_ORG_USER_PERMISSIONS_SUCCESS";
export const UPDATE_ORG_USER_PERMISSIONS_FAIL = "UPDATE_ORG_USER_PERMISSIONS_FAIL";

export const GET_ORG_AUDIT_LOG_START = "GET_ORG_AUDIT_LOG_START";
export const GET_ORG_AUDIT_LOG_SUCCESS = "GET_ORG_AUDIT_LOG_SUCCESS";
export const GET_ORG_AUDIT_LOG_FAIL = "GET_ORG_AUDIT_LOG_FAIL";

export const GET_ADMIN_STATS_START = "GET_ADMIN_STATS_START";
export const GET_ADMIN_STATS_SUCCESS = "GET_ADMIN_STATS_SUCCESS";
export const GET_ADMIN_STATS_FAIL = "GET_ADMIN_STATS_FAIL";

export const GET_ADMIN_ORGS_START = "GET_ADMIN_ORGS_START";
export const GET_ADMIN_ORGS_SUCCESS = "GET_ADMIN_ORGS_SUCCESS";
export const GET_ADMIN_ORGS_FAIL = "GET_ADMIN_ORGS_FAIL";
