...
// import { userList } from "../BookmarkPage/userList";
...
function BookmarkPage({ background = "white", textColor = "black" }) {
  ...
  useEffect(() => {
    const getBookmarkedFeed = async () => {
      getBookmarkedTutorialFeedData(profileData?.bookmarked)(firebase, firestore, dispatch);
    };
    getBookmarkedFeed();
  }, [dispatch]);
    ...
    >
      <Grid container justifyContent="center" className={classes.contentPart}>
        ...
        <Grid
          ...
          data-testId="BookmarkPageMainBody"
          xs={6}
        >
        ...
        <Grid item className={classes.sideBody} xs={3}>
          <Grid
            ...
            data-testId="BookmarkPageTagSidebar"
          >
          ...
          <Grid
            ...
            data-testId="BookmarkPageUpcomingEvents"
          >
            <Grid item style={{ minWidth: "100%" }}>
              <EventsCard title={"Upcoming Events"} events={upcomingEvents} />
            </Grid>
          ...
          <Grid
            ...
            data-testId="BookmarkPageUsersToFollow"
          >
            <Grid item style={{ minWidth: "100%" }}>
              <UserCard title={"Who to Follow"} users={usersToFollow} />
            </Grid>
          ...
          <Grid
            ...
            data-testId="BookmarkPageContributors"
          >
            <Grid item style={{ minWidth: "100%" }}>
              <UserCard title={"Contributors"} users={contributors} />
            </Grid>
          ...
          <Grid
            ...
            data-testId="BookmarkPagePopularEventSidebar"
          >
            <Grid item style={{ minWidth: "100%" }}>
              <EventsCard title={"Popular Events"} events={upcomingEvents} />
            </Grid>
