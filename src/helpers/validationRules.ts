// Validation rule type matching Ant Design's form validation interface
...
// org validation
export const orgWebsiteValidation: ValidationRule[] = [
  {
    required: true,
...
export const orgSMValidation: ValidationRule[] = [
  {
    required: false,
    message: "Please enter the website of the organization"
  }
...
export const orgHandleValidation: ValidationRule[] = [
  {
    required: true,
...
export const orgNameValidation: ValidationRule[] = [
  {
    required: true,
...
// user validation
export const userHandleValidation: ValidationRule[] = [
  {
    required: true,
...
export const userWebsiteValidation: ValidationRule[] = [
  {
    pattern: new RegExp(
      /^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)?[a-z0-9]+([-.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/
    ),
...
export const tutorialTitleNameValidation: ValidationRule[] = [
  {
    required: true,
...
export const tutorialOwnerValidation: ValidationRule[] = [
  {
    required: true,
...
export const addNewStepNameValidation: ValidationRule[] = [
  {
    required: true,
...
export const addNewStepTimeValidation: ValidationRule[] = [
  {
    required: true,
